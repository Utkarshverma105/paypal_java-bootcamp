...
//	      MathOperation division = (int a, int b) -> a / b;
	      ...
	      System.out.println("10 x 5 = " + lamExp.operate(10, 5, (a, b) -> a * b));
	      System.out.println("10 / 5 = " + lamExp.operate(10, 5, (a, b) -> a / b));
	      
	  
	      //with parenthesis and using custom functional interface
	      GreetingService greetService2 = (String message) -> {String msg = "Hello " + message; System.out.println("Hello " + message);};
	      greetService2.sayMessage("Suresh");
		   ...
		   BiConsumer<String, String> greetings = (firstName, lastName) -> System.out.print("Hello " + firstName + " " + lastName);
		   greetings.accept("Ajay", "Kumar");
	   }
